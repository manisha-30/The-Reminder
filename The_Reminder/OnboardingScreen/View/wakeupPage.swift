...
class wakeupPage: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        setupUI()
        if UserDefaults.standard.string(forKey: "selectedWakeup") == nil{
            UserDefaults.standard.setValue("6.00 AM", forKey: "selectedWakeup")
        }
    }

    override func viewWillAppear(_ animated: Bool) {
        super.viewWillAppear(animated)
        let initialPickerValue = UserDefaults.standard.string(forKey: "selectedWakeup") ?? "6.00 AM"
    ...
    @objc func dueDateChanged(){
        ...
        UserDefaults.standard.setValue(timeStamp, forKey: "selectedWakeup")
        updateTopView()
    ...
    @objc func frwdTapped(){
        ...
        let vc = storyboard.instantiateViewController(identifier: "sleepPage") as! sleepPage
